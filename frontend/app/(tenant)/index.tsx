          ...
          {totalDue > 0 && (
            <View style={styles.dueBanner}>
              ...
              <Text style={styles.dueBannerText}>
                ...
                <Text style={{ fontWeight: "800" }}>{fmt(totalDue)}</Text>
              </Text>
            </View>
          )}
          ...
          {records.length === 0 ? (
            <View style={styles.empty}>
              ...
              <Text style={styles.emptyText}>
                No rent records for {SHORT_MONTHS[month - 1]} {year}
              </Text>
            </View>
          ) : (
            records.map((r) => (
  ...
  return (
    <View style={styles.card}>
      ...
      >
        ...
        <View style={styles.topRight}>
          <Text
            style={[
              styles.totalAmt,
              { color: isPaid ? colors.success : colors.text },
            ]}
          >
            {fmt(r.total)}
          </Text>
      ...
      <View style={styles.breakdown}>
        ...
        {r.electricity > 0 && (
          <BreakdownRow label="Electricity" value={r.electricity} />
        )}
        {r.carry_forward !== 0 && (
          <BreakdownRow
            label={
        ...
        {(r.advance_amount ?? 0) > 0 && !r.advance_adjusted && (
          <View style={styles.advanceInfo}>
            ...
            <Text style={styles.advanceInfoText}>
              Advance on file: {fmt(r.advance_amount!)}
            </Text>
          </View>
        )}
        {r.vacating_date && (
          <View style={styles.vacatingInfo}>
            ...
            <Text style={styles.vacatingInfoText}>
              Moving out:{" "}
              {new Date(r.vacating_date).toLocaleDateString("en-IN", {
                day: "numeric",
                month: "short",
                year: "numeric",
              })}
          ...
          {r.vacating_date ? (
            ...
            <View style={styles.section}>
              ...
              >
                ...
                />
                <Text style={styles.moveoutLinkText}>
              ...
              {r.landlord_upi ? (
                <>
                  ...
                  <Text style={styles.upiHint}>
                    Opens GPay / PhonePe / Paytm. Enter amount on the UPI app.
                  </Text>
                </>
              ) : (
                <Text style={styles.noUpi}>
                  Landlord hasn't set a UPI ID yet.
                </Text>
              )}
            </View>
          )}
